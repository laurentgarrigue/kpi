						...
						<table>
							<tr>
								...
								<td>
									...
									<a href="ExportDistanceEquipes.php?compet={$codeCompet}" title="{#Distances_kilometriques#} (ODS)"><img
											height="25" src="../img/ods.png" /><br>Km</a>
									{if $codeCompet == 'POOL'}
									...
									<tr class='{cycle values="impair,pair"}'>
										...
										{if $profile <= 2 && $AuthModif == 'O'}
											<td>
												<a href="#" class="editEquipe" data-equipe="{$arrayEquipe[i].Id}"
													...
													data-color2="{$arrayEquipe[i].color2}" data-colortext="{$arrayEquipe[i].colortext}"
													data-logo="{$arrayEquipe[i].logo}" data-numero="{$arrayEquipe[i].Numero}">
										...
										<td class="centre">
											{if $arrayEquipe[i].color1}
												<b class="team_colors"
													style="background-color: {$arrayEquipe[i].color1}; border: 3px solid {$arrayEquipe[i].color2|default:$arrayEquipe[i].color1}; color: {$arrayEquipe[i].colortext|default:'black'};">1
												</b>
											{/if}
										</td>
						...
						<table width=100% id="editTeam" class='tableau'>
							...
							<tr class="impair">
								<td>
									...
									<br>
									{#Texte#}:
									<input type="color" name="editTeamColortext" id="editTeamColortext">
								</td>
								<td>
