...
<html lang="fr" xmlns:og="http://ogp.me/ns#">
    <head>
        ...
        <link rel='stylesheet' id='bootstrap5-css' href='{$adm}vendor/twbs/bootstrap/dist/css/bootstrap.min.css?v={$NUM_VERSION}' type='text/css' media='all' />
        {* Bootstrap 5 compatibility layer (Bootstrap 3 → 5 mappings + KPI custom styles) *}
        <link rel='stylesheet' id='bootstrap5-compat-css' href='{$adm}css/bootstrap5_compat.css?v={$NUM_VERSION}' type='text/css' media='all' />
