...
<template>
  <div>
    ...
    <div v-else class="border border-header-300 dark:border-header-700 rounded-md overflow-hidden">
      <!-- "All" option -->
      <label
        class="flex items-center gap-2 p-2 hover:bg-header-50 dark:hover:bg-header-800 cursor-pointer border-b border-header-200 dark:border-header-700"
      >
        <input
          type="checkbox"
          :checked="allSelected"
          ...
          @change="toggleAll"
        >
        <span class="font-medium text-header-900 dark:text-header-50">
      ...
      <div class="max-h-48 overflow-y-auto">
        <label
          ...
          :key="comp.code"
          class="flex items-center gap-2 p-2 hover:bg-header-50 dark:hover:bg-header-800 cursor-pointer"
        >
          <input
            type="checkbox"
