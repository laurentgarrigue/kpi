...
<template>
  ...
  <div v-if="!compact" class="mb-4 px-4 py-1 bg-primary-50 dark:bg-primary-950 border border-primary-200 dark:border-primary-800 rounded-lg w-fit">
    <div class="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-start gap-2 sm:gap-8">
      ...
      <NuxtLink
        to="/"
        class="inline-flex items-center gap-1 self-start px-3 py-1.5 text-sm font-medium text-primary-700 dark:text-primary-200 bg-primary-100 dark:bg-primary-900 hover:bg-primary-200 dark:hover:bg-primary-800 rounded-lg transition-colors"
      >
  ...
  <div v-else class="flex flex-wrap items-center gap-2 bg-primary-50 dark:bg-primary-950 border border-primary-200 dark:border-primary-800 rounded-md px-2.5 py-1 text-sm">
    ...
    <NuxtLink
      to="/"
      class="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-primary-800 dark:text-primary-200 bg-primary-200 dark:bg-primary-800 hover:bg-primary-300 dark:hover:bg-primary-700 rounded transition-colors"
    >
