  ...
  <div class="flex flex-wrap items-end gap-3">
    ...
    <div v-if="needs('pitchs')" class="flex flex-col gap-1">
      ...
      <input
        ...
        type="text"
        class="px-3 py-2 text-sm border border-header-300 rounded-lg bg-white w-32"
        placeholder="1,2,3,4"
      >
    </div>
    ...
    <div v-if="needs('lnStart')" class="flex flex-col gap-1">
      ...
      <input
        ...
        type="number"
        min="1"
        class="px-3 py-2 text-sm border border-header-300 rounded-lg bg-white w-20"
      >
    </div>
    ...
    <div v-if="needs('competList')" class="flex flex-col gap-1">
      ...
      <input
        ...
        type="text"
        class="px-3 py-2 text-sm border border-header-300 rounded-lg bg-white w-40"
        placeholder="CMH,CMF"
      >
    </div>
