...
<template>
  <div class="flex flex-wrap items-end gap-3">
    ...
    <div v-if="needs('competition')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.competition') }}</label>
      <select
        v-model="panel.competition"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50 min-w-[120px]"
      >
        <option value="">—</option>
    ...
    <div v-if="needs('match')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.match') }}</label>
      <select
        v-model.number="panel.match"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50 min-w-[280px]"
      >
    ...
    <div v-if="needs('team')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.team') }}</label>
      <select
        v-model="panel.team"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50"
      >
    ...
    <div v-if="needs('number')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.player') }}</label>
      <AdminTvPlayerNumberGrid v-model="panel.number" />
    </div>

    <!-- Pitch -->
    <div v-if="needs('pitch')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.pitch') }}</label>
      <select
    ...
    <div v-if="needs('pitchs')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.pitchs') }}</label>
      <input
        v-model="panel.pitchs"
        type="text"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50 w-32"
        placeholder="1,2,3,4"
      >
    </div>
    ...
    <div v-if="needs('medal')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.medal') }}</label>
      <select
        v-model="panel.medal"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50"
      >
    ...
    <div v-if="needs('zone')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.zone') }}</label>
      <select
        v-model="panel.zone"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50"
      >
    ...
    <div v-if="needs('mode')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.mode') }}</label>
      <select
        v-model="panel.mode"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50"
      >
    ...
    <div v-if="needs('round')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.round') }}</label>
      <select
        v-model="panel.round"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50"
      >
    ...
    <div v-if="needs('start')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.start') }}</label>
      <select
    ...
    <div v-if="needs('animate')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.animate') }}</label>
      <select
    ...
    <div v-if="needs('speaker')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.speaker') }}</label>
      <select
    ...
    <div v-if="needs('count')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.count') }}</label>
      <select
    ...
    <div v-if="needs('lnStart')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.first_game') }}</label>
      <input
        v-model.number="panel.lnStart"
        type="number"
        min="1"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50 w-20"
      >
    </div>

    <!-- Game count (lnLen) -->
    <div v-if="needs('lnLen')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.game_count') }}</label>
      <input
    ...
    <div v-if="needs('competList')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.competitions') }}</label>
      <input
        v-model="panel.competList"
        type="text"
        class="px-3 py-2 text-sm border border-header-300 dark:border-header-700 rounded-lg bg-white dark:bg-header-900 text-header-900 dark:text-header-50 w-40"
        placeholder="CMH,CMF"
      >
    </div>
    ...
    <div v-if="needs('format')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.format') }}</label>
      <select
    ...
    <div v-if="needs('option')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.option') }}</label>
      <select
    ...
    <div v-if="needs('navGroup')" class="flex flex-col gap-1">
      <label class="text-xs font-medium text-header-900 dark:text-header-50">{{ t('tv.panel.navbar') }}</label>
      <select
