  ...
  <div class="bg-white rounded-lg shadow border border-header-200 p-4 flex flex-col">
    ...
    <div class="flex gap-4 flex-1">
      ...
      <div class="flex-1 min-w-0 space-y-3">
        ...
        <div class="flex flex-wrap items-end gap-3">
          <div class="flex flex-col gap-1">
            <label class="text-xs font-medium text-header-900">{{ t('tv.panel.channel') }}</label>
          ...
          <div class="flex flex-col gap-1">
            <label class="text-xs font-medium text-header-900">{{ t('tv.panel.presentation') }}</label>
      ...
      <div class="flex flex-col items-end gap-2 shrink-0">
        <button
          type="button"
          class="text-header-600 hover:text-danger-500 p-1 transition-colors"
    ...
    <div class="flex flex-wrap items-center gap-2 mt-4 pt-3 border-t border-header-100">
      ...
      <button
        v-if="panel.match"
        type="button"
        class="px-3 py-1.5 text-sm font-medium text-header-900 bg-header-50 rounded-lg hover:bg-header-200 transition-colors"
        @click="openReport"
      >
        {{ t('tv.actions.report') }}
      </button>
      ...
      <input
        ...
        readonly
        class="flex-1 px-3 py-1.5 text-xs border border-header-200 rounded-lg bg-header-50 text-header-900 min-w-[200px]"
      ...
      <button
        type="button"
        class="px-3 py-1.5 text-sm font-medium text-header-900 bg-header-200 rounded-lg hover:bg-header-200 transition-colors"
      ...
      <button
        type="button"
        class="px-4 py-1.5 text-sm font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 transition-colors disabled:opacity-50"
        :disabled="!panel.channel || activating"
        @click="activate"
      >
