...
<template>
  <div v-if="workContext.hasValidContext" class="flex items-center gap-2 text-sm text-header-600 dark:text-header-300 mb-4">
    ...
    <span class="text-header-400 dark:text-header-500">({{ t('context.competitions_count', { count: workContext.competitionCount }) }})</span>
