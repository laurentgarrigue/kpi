        ...
        <div class="p-4 space-y-3">
          ...
          <div>
            ...
            <select
              ...
              class="w-full px-3 py-2 border border-header-300 rounded-lg bg-white text-header-900 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
            >
