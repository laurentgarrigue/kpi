...
export default defineNuxtConfig({
  ...
  pwa: {
    ...
    manifest: {
      name: 'KPI Live - Live Display',
      short_name: 'KPI Live',
      description: 'Kayak Polo Information - Live scores display for events',
      theme_color: '#1f2937',
    ...
    workbox: {
      ...
      runtimeCaching: [
        ...
        {
          urlPattern: /^.*\/live\/cache\/.*\.json$/,
          handler: 'NetworkFirst',
          options: {
            cacheName: 'live-cache',
            expiration: {
              maxEntries: 100,
              maxAgeSeconds: 60 // 1 minute cache for live data
            }
          }
        }
      ]
